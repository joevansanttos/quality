...
@section("titulo")
<div class="x_title">
  <h2>Adicionar Observações do Auditor</h2>
...
<form action="adiciona" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
 ...
 <div class="form-group">
   <label class="control-label col-md-3 col-sm-3 col-xs-12" for="observacoes">Observações<span class="required">*</span>
   </label>
   <div class="col-md-6 col-sm-6 col-xs-12">
      <textarea  name="observacoes" class="form-control col-md-12 col-xs-12" rows="6"></textarea>
   </div>
 </div>
