...
@section("titulo")
<div class="x_title">
  <h2>Adicionar Sumário de Não Conformidade da  Auditoria</h2>
...
<form action="alterar" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
 ...
 <div class="item form-group">
   ...
   <div class="col-sm-6 col-xs-12 col-md-2">
     <input type="text" id="maior" name="maior" value="{{$a->maior}}" required="required" class="form-control col-md-7 col-xs-12">
   </div>
   <label class="control-label col-md-2 col-sm-3 col-xs-12" for="menor">Menor <span class="required">*</span>
   </label>
   <div class="col-sm-6 col-xs-12 col-md-2">
     <input type="text" id="menor" name="menor" value="{{$a->menor}}"  required="required"  class="form-control col-md-7 col-xs-12">
   </div> 
 </div>
 <div class="item form-group">
  ...
  <div class="col-sm-2 col-xs-12 col-md-3">
    <input type="text" id="followup" name="followup" value="{{$a->followup}}" required="required" class="form-control col-md-7 col-xs-12">
  </div>
  <label class="control-label col-md-1 col-sm-3 col-xs-12" for="data_followup">Data</label>
  <div class="col-sm-2 col-xs-12 col-md-2">
    <input type="date" id="data_followup" name="data_followup" value="{{$a->data_followup}}" data-validate-length-range="6,20" class="form-control col-md-7 col-xs-12">
  </div>
 </div>
 <div class="item form-group">
  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="duracao">Duração (Dias)<span class="required">*</span></label>
  <div class="col-sm-2 col-xs-12 col-md-3">
    <input type="text" id="duracao" name="duracao" value="{{$a->duracao}}" class="form-control col-md-7 col-xs-12">
  </div>
  <label class="control-label col-md-1 col-sm-3 col-xs-12" for="atual_followup">Data de Follow Up atual</label>
  <div class="col-sm-2 col-xs-12 col-md-2">
    <input type="date" id="atual_followup" name="atual_followup" value="{{$a->atual_followup}}" data-validate-length-range="6,20" class="form-control col-md-7 col-xs-12">
  </div>
 </div>  
 ...
 <div class=" form-group">
  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
    ...
    <input type="hidden" name="auditoria_sumarionc_id" value="{{$a->id}}">
  </div>
</div>
</form>
