...
@section("titulo")
<div class="x_title">
  <h2>Alterar Plano da  Auditoria</h2>
...
<form action="alterar" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
 ...
 <div class="item form-group">
   ...
   <div class="col-sm-2 col-xs-12 col-md-2">
     <input type="text" id="horario" name="horario" value="{{$a->horario}}" data-inputmask="'mask' : '99:99'" required="required" data-validate-length-range="6,20" class="form-control col-md-7 col-xs-12">
   </div>
 </div>
 <div class="form-group">
   ...
   <div class="col-md-6 col-sm-6 col-xs-12">
     <input  type="text"  id="atividade" name="atividade" value="{{$a->atividade}}" required="required" class="form-control col-md-6 col-xs-12">
   </div>
 </div>
 <div class="form-group">
   ...
   <div class="col-md-6 col-sm-6 col-xs-12">
     <input  type="text"  id="site" name="site" value="{{$a->site}}" required="required" class="form-control col-md-6 col-xs-12">
   </div>
 </div>
 <div class="form-group">
 ...
 <div class="form-group">
   ...
   <div class="col-md-6 col-sm-6 col-xs-12">
     <textarea  name="clausula" class="form-control col-md-12 col-xs-12" rows="6">{{$a->clausula}}</textarea> 
   </div>
 </div>
 ...
 <div class=" form-group">
  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
    ...
    <input type="hidden" name="auditoria_plano_id" value="{{$a->id}}">
  </div>
</div>
</form>
