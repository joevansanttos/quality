...
@section("titulo")
<div class="x_title">
  <h2>Adicionar Descrição do Relatório de Não Conformidades</h2>
...
<form action="alterar" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
 ...
 <div class="form-group">
   ...
   <div class="col-md-6 col-sm-6 col-xs-12">
      <textarea  name="descricao" class="form-control col-md-12 col-xs-12" rows="10">{{$a->descricao}}</textarea>
   </div>
 </div>
 ...
 <div class=" form-group">
  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
    ...
    <input type="hidden" name="auditoria_detalhenaoconformidade_id" value="{{$a->id}}">
  </div>
</div>
</form>
