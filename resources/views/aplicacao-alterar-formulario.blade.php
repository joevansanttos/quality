...
@section("cabecalho")
<h3>Alterar Aplicacao</h3>
@stop

@section("conteudo")
<form action="/pis/aplicacao/alterar" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
	...
	<div class="form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			<textarea  name="descricao" class="form-control col-md-12 col-xs-12" rows="6">{{$a->descricao}}</textarea> 
		</div>
	</div>  	             
	...
	<div class=" form-group">
		<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
			...
			<input type="hidden" name="aplicacao_id" value="{{$a->id}}">
		</div>
	</div>
</form>
