  ...
  @foreach ($clientes as $c)
    <tr>
      ...
      <td align="center">
        ...
        <a href="departamentos/novo/{{$c->id}}"><button data-toggle="tooltip" data-placement="top" title="Remove Cliente" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button></a>            
      </td>
    </tr>
  @endforeach
</table>
