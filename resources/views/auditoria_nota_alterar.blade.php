...
@section("titulo")
<div class="x_title">
  <h2>Alterar Notas da Auditoria</h2>
...
<form action="alterar" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
  ...
  <div class="item form-group">
   ...
   <div class="col-sm-2 col-xs-12 col-md-3">
     <input type="text" id="processo" name="processo" value="{{$a->processo}}" required="required" class="form-control col-md-7 col-xs-12">
   </div>
   <label class="control-label col-md-1 col-sm-3 col-xs-12" for="data">Data</label>
   <div class="col-sm-2 col-xs-12 col-md-2">
     <input type="date" id="data" name="data" required="required" value="{{$a->data}}" data-validate-length-range="6,20" class="form-control col-md-7 col-xs-12">
   </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      <input  type="text"  id="pessoal" name="pessoal" required="required" value="{{$a->pessoal}}" class="form-control col-md-6 col-xs-12">
    </div>
  </div>
  <div class="form-group">
   ...
   <div class="col-md-6 col-sm-6 col-xs-12">
     <textarea  name="notas" class="form-control col-md-12 col-xs-12" rows="12">{{$a->notas}}</textarea> 
   </div>
  </div>           
  ...
  <div class=" form-group">
    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
      ...
      <input type="hidden" name="auditoria_nota_id" value="{{$a->id}}">
    </div>
  </div>
</form>
