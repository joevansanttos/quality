...
<form action="alterar" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
	...
	<div class="form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			<input  data-inputmask="'mask' : '9{1,2}'" type="text" value="{{$s->numero}}"  id="processo" name="numero" required="required" class="form-control col-md-6 col-xs-12">
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			<input type="text"  id="t_processo" name="titulo" value="{{$s->titulo}}" required="required" class="form-control col-md-7 col-xs-12">
		</div>
	</div>
	<div class="item form-group">
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
			<input type="text" data-inputmask="'mask' : '9{1,5}'"  value="{{$s->pessoas}}" id="pessoas" name="pessoas" required="required" class="form-control">
		</div>         
		<label for="horas" class="control-label col-md-1">Horas <span class="required">*</span>
		</label>
		<div class="col-md-2 col-sm-6 col-xs-12">
			<input type="text" data-inputmask="'mask' : '9{1,5}'" value="{{$s->horas}}" id="horas" name="horas" required="required" class="form-control">
		</div>		            	  	  
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class=" col-sm-6 col-xs-12 col-md-6">
			...
			<div class="form-group">
				<input type="text" placeholder="Cargo" id="profissao" name="cargo" value="{{$g->cargo}}" required="required" class="form-control col-md-7 col-xs-12">
			</div>
			<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			<textarea  name="descricao" class="form-control col-md-12 col-xs-12" rows="6">{{$s->descricao}}</textarea> 
		</div>
	</div>  		  	             
	...
	<div class=" form-group">
      ...
      <input type="hidden" name="gestor_sub_id" value="{{$g->id}}">
		</div>
	</div>
</form>
...
<script type="text/javascript">
  document.getElementById('classificacao_id').value = '{{$s->classificacao_id}}';
</script>

<script type="text/javascript">
  document.getElementById('periodicidade_id').value = '{{$s->periodicidade_id}}';
</script>

<script type="text/javascript">
  document.getElementById('maturidade_id').value = '{{$s->maturidade_id}}';
</script>
